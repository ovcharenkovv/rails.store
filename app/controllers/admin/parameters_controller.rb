class Admin::ParametersController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @parameter.save
        format.html { redirect_to(admin_parameters_path, :notice => 'Parameter was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @parameter.update_attributes(params[:parameter])
        format.html { redirect_to(admin_parameters_path, :notice => 'Parameter was successfully updated.') }
        format.xml  { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(admin_parameters_path) }
      format.xml  { head :ok }
    end
  end
end
